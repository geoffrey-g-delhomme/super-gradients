...
# %%
model = models.get(MODEL, num_classes=1, checkpoint_path=f"{CHECKPOINT_DIRPATH}/{EXPERIMENT}/average_model.pth").cuda()
...
onnx_filename = f"qat.onnx"

dummy_input = torch.randn([1, 3, 2048, 2048], device="cpu")
