...
__all__ = ["AbstractIntersectEstimationDecodingModule", "IntersectEstimationModelExportResult", "ExportableIntersectEstimationModel"]


class AbstractIntersectEstimationDecodingModule(nn.Module):
    """
    Abstract class for decoding outputs from pose estimation model into to a tuple of four tensors (boxes, scores, poses, lines)
    """

    @abc.abstractmethod
    def forward(self, predictions: Any) -> Tuple[Tensor, Tensor, Tensor, Tensor]:
        """
...
class IntersectEstimationModelExportResult:
    """
...
class ExportableIntersectEstimationModel:
    """
    A mixin class that adds export functionality to the intersect estimation models.
    ...
    def export(
        ...
        if isinstance(postprocessing, nn.Module):
            ...
            postprocessing_module: AbstractIntersectEstimationDecodingModule = model.get_decoding_module(**postprocessing_kwargs)
        ...
        return IntersectEstimationModelExportResult(
            input_image_channels=input_image_channels,
            input_image_dtype=input_image_dtype,
            input_image_shape=input_image_shape,
            engine=engine,
