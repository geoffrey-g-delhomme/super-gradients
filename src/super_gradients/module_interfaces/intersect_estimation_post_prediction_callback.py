...
__all__ = ["IntersectEstimationPredictions", "AbstractIntersectEstimationPostPredictionCallback"]


@dataclasses.dataclass
class IntersectEstimationPredictions:
    """
    ...
    lines: Union[Tensor, np.ndarray] # [..., 5](x_from,y_from,x_to,y_to,conf)
    bboxes_xyxy: Optional[Union[Tensor, np.ndarray]]


class AbstractIntersectEstimationPostPredictionCallback(abc.ABC):
    """
    A protocol interface of a post-prediction callback for pose estimation models.
    """

    @abc.abstractmethod
    def __call__(self, predictions: Any) -> List[IntersectEstimationPredictions]:
        ...
