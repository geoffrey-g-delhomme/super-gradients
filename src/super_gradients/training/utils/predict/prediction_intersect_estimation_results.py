...
from super_gradients.training.utils.predict import ImagePrediction, ImagesPredictions, VideoPredictions, IntersectEstimationPrediction
...
@dataclass
class ImageIntersectEstimationPrediction(ImagePrediction):
    ...
    image: np.ndarray
    prediction: IntersectEstimationPrediction
    ...
    def draw(
        ...
        """
        image = IntersectVisualization.draw_poses(
            image=self.image,
            poses=self.prediction.poses,
            scores=self.prediction.scores,
            lines=self.prediction.lines,
            is_crowd=None,
...
@dataclass
class ImagesIntersectEstimationPrediction(ImagesPredictions):
    """Object wrapping the list of image detection predictions.

    :attr _images_prediction_lst:  List of the predictions results
    """

    _images_prediction_lst: List[ImageIntersectEstimationPrediction]
...
@dataclass
class VideoIntersectEstimationPrediction(VideoPredictions):
    ...
    _images_prediction_gen: Iterator[ImageIntersectEstimationPrediction]
    fps: int
    n_frames: int
