...
class YoloNASIntersectDFLHead(BaseDetectionModule, SupportsReplaceNumClasses):
    """
    YoloNASIntersectDFLHead is the head used in YoloNASIntersect model.
    ...
    def forward(self, x) -> Tuple[Tensor, Tensor, Tensor, Tensor, Tensor, Tensor]:
        ...
        :return: Tuple of [reg_output, cls_output, pose_regression, pose_logits]
            ...
            - line_regression: Tensor of [B, num_lines, 2, H, W]
            - line_logits:     Tensor of [B, num_lines, H, W]
        """
        x = self.stem(x)
